package com.dino.redis.service.impl;
...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public <T> Long lPushAllList(String key, Collection<T> values) {
        return redisTemplate.opsForList().rightPushAll(key, values);
    }
    ...
    @Override
    public <T> Long lRemoveNotification(String key, long count, T value) {
        return redisTemplate.opsForList().remove(key, count, value);
    }
